      ...
      <Card className="w-full max-w-sm">
        <CardHeader className="items-center text-center">
          <div className="mx-auto mb-2 flex size-14 items-center justify-center rounded-full bg-muted">
            <Image src={football} alt="" className="size-8" />
          </div>
          <CardTitle className="text-2xl">Penalty Merchants</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          ...
          >
            {/* Google's mark keeps its brand colors — hardcoded fills are correct here. */}
